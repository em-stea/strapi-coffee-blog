...
export interface ApiAccesoryAccesory extends Struct.CollectionTypeSchema {
  collectionName: 'accesories';
  info: {
    displayName: 'Accesory';
    pluralName: 'accesories';
    singularName: 'accesory';
  };
  options: {
  ...
  attributes: {
    ...
    instructionsForUse: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::accesory.accesory'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBrewMethodBrewMethod extends Struct.CollectionTypeSchema {
  collectionName: 'brew_methods';
  info: {
    displayName: 'Brew Method';
    pluralName: 'brew-methods';
...
export interface ApiCoffeeDrinkCoffeeDrink extends Struct.CollectionTypeSchema {
  collectionName: 'coffee_drinks';
  info: {
    displayName: 'Coffee Drink';
    pluralName: 'coffee-drinks';
    singularName: 'coffee-drink';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCoffeeVarietyCoffeeVariety
  ...
  info: {
    displayName: 'Coffee Variety';
    pluralName: 'coffee-varieties';
    singularName: 'coffee-variety';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    flavorProfile: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::coffee-variety.coffee-variety'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    origin: Schema.Attribute.Relation<'oneToOne', 'api::origin.origin'>;
    process_method: Schema.Attribute.Relation<
      'oneToOne',
      'api::process-method.process-method'
    >;
    publishedAt: Schema.Attribute.DateTime;
    roast_level: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiGrinderGrinder extends Struct.CollectionTypeSchema {
  collectionName: 'grinders';
  info: {
    displayName: 'Grinder';
    pluralName: 'grinders';
  ...
  attributes: {
    burrType: Schema.Attribute.Enumeration<
      ['Flat Burrs', 'Conical Burrs', 'Blade']
    >;
    cover: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiOriginOrigin extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    altitudeRange: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiProcessMethodProcessMethod
  extends Struct.CollectionTypeSchema {
  collectionName: 'process_methods';
  info: {
    displayName: 'Process Method';
    pluralName: 'process-methods';
    singularName: 'process-method';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRoastLevelRoastLevel extends Struct.CollectionTypeSchema {
  collectionName: 'roast_levels';
  info: {
    displayName: 'Roast Level';
    pluralName: 'roast-levels';
    singularName: 'roast-level';
  };
  options: {
    draftAndPublish: true;
  };
